...
const translations: Record<Lang, Record<string, string>> = {
    en: {
        ...
        "hero.desc": "Free, open-source file conversion that runs entirely in your browser. Your files never leave your device. No uploads, no servers, no tracking.",
        "hero.cta": "Start Converting",
        "hero.github": "View on GitHub",
        "hero.trust1": "No Data Collection",
        "hero.trust2": "Fully Open Source",
        ...
        "features.f5.title": "Free & Open Source",
        "features.f5.desc": "No subscriptions, no limits, no hidden fees. Fully open-source under the MIT license.",
        ...
        "cta.desc": "No sign-ups, no downloads, no tracking. 100% open-source. Just drag, drop, and convert.",
        "cta.primary": "Open Converter",
        "cta.secondary": "View on GitHub",

        // ── Footer ──
        "footer.desc": "Free, open-source file conversion that runs entirely in your browser. No uploads, no servers, no tracking.",
    ...
    es: {
        ...
        "hero.desc": "Conversión de archivos gratuita y de código abierto que se ejecuta completamente en tu navegador. Tus archivos nunca salen de tu dispositivo. Sin subidas, sin servidores, sin rastreo.",
        "hero.cta": "Empezar a Convertir",
        "hero.github": "Ver en GitHub",
        "hero.trust1": "Sin Recolección de Datos",
        "hero.trust2": "Código Abierto",
        ...
        "features.f5.title": "Gratis y de Código Abierto",
        "features.f5.desc": "Sin suscripciones, sin límites, sin tarifas ocultas. Completamente de código abierto bajo la licencia MIT.",
        ...
        "cta.desc": "Sin registros, sin descargas, sin rastreo. 100% código abierto. Solo arrastra, suelta y convierte.",
        "cta.primary": "Abrir Convertidor",
        "cta.secondary": "Ver en GitHub",

        // ── Footer ──
        "footer.desc": "Conversión de archivos gratuita, de código abierto y privada que se ejecuta completamente en tu navegador. Sin subidas, sin servidores, sin rastreo.",
